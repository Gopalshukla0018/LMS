       ...
       <div className="relative z-10 grid max-w-6xl gap-12 lg:grid-cols-2">
         ...
         <div className="flex flex-col items-start text-left">
           ...
           <div className="flex gap-4">
             <Button  onClick={()=> navigate(`/login`)}  className="px-6 py-3 text-white bg-gradient-to-r from-pink-500 to-yellow-500 hover:opacity-90">
               Get Started
             </Button>
             <Button onClick={()=> navigate(`/course/search?query`)} variant="outline" className="px-6 py-3 text-indigo-700 border-white hover:bg-white hover:text-indigo-700">
               Explore Courses
             </Button>
           </div>
         </div>
